        ...
        <div className="min-h-screen bg-blue-500 py-6 flex flex-col justify-center sm:py-12">
            <div className="py-3 sm:max-w-xl sm:mx-auto w-full px-2 sm:px-0">
                <div className="flex flex-col gap-2 text-center mb-8">
                    <h2 className="text-3xl font-extrabold leading-tight text-white lg:text-4xl mb-4">How It works?</h2>
                </div>
                <div className="relative text-gray-700 antialiased text-sm font-semibold">
                    ...
                    <div className="flex flex-col sm:flex-row items-center">
                        ...
                        <LiaFileInvoiceDollarSolid color="white" size={'1.1rem'} />
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center">
                        ...
                        <CgProfile color="white" size={'1.1rem'} />
                        </div>
                    </div>
                    </div>
                    {/* Left section, set by justify-start and sm:pr-8 */}
                    ...
                    <div className="flex flex-col sm:flex-row items-center">
                        ...
                        <div className="w-full sm:w-1/2 sm:pr-8">
                            <div className="p-4 bg-white rounded shadow">
                            You confirm your users, workflow stakeholders and beneficiaries
                            </div>
                        </div>
                        </div>
                        <div className="rounded-full bg-blue-500 border-white border-4 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                        ...
                        <PiUsersFourBold color="white" size={'1.1rem'} />
                        </div>
                    </div>
                    </div>
                    {/* Right section, set by justify-end and sm:pl-8 */}
                    ...
                    <div className="flex flex-col sm:flex-row items-center">
                        ...
                        <div className="w-full sm:w-1/2 sm:pl-8">
                            <div className="p-4 bg-white rounded shadow">
                            We start scanning and reporting in line with automated process
                            </div>
                        </div>
                        </div>
                        <div className="rounded-full bg-blue-500 border-white border-4 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                        ...
                        <MdOutlineDocumentScanner color="white" size={'1.1rem'} />
                        </div>
                    </div>
                    </div>
                </div>
